module.exports=[61899,a=>{"use strict";async function b(b,c){let d=`
  ...
  `;try{let{shopifyFetch:d}=await a.A(39599),e=await d(c,{customerAccessToken:b});if(e.customerAccessTokenDelete.userErrors.length>0)return{success:!1,errors:e.customerAccessTokenDelete.userErrors.map(a=>a.message)};return{success:!0}}catch(a){return console.error("Logout customer failed:",a),{success:!1,errors:["Logout failed. Please try again"]}}}async function d(b,c,e,f,g=!1){let h=`
  ...
  `;try{let{shopifyFetch:d}=await a.A(39599),i=await d(h,{input:{firstName:b,lastName:c,email:e,password:f,acceptsMarketing:g}});if(i.customerCreate.customerUserErrors.length>0)return{success:!1,errors:i.customerCreate.customerUserErrors.map(a=>a.message)};return{success:!0,customer:i.customerCreate.customer}}catch(a){return console.error("Create customer failed:",a),{success:!1,errors:["Sign up failed. Please try again"]}}}async function e(b){let c=`
